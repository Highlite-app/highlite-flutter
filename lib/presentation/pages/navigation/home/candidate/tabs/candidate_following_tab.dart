...
class CandidatesFollowing extends StatefulWidget {
  const  CandidatesFollowing({super.key});

  @override
  State<CandidatesFollowing> createState() => _CandidatesFollowingState();
}

class _CandidatesFollowingState extends State<CandidatesFollowing> {

  late CompanyOnboarding companyProfile ;
